...
<template>
  <div ref="navbar" class="app-nav backdrop-filter backdrop-blur-md top-0 z-40 w-full flex-none transition-colors duration-300 lg:z-50 border-b border-gray-900/10 dark:border-gray-50/[0.2] bg-white/[0.5] dark:bg-slate-900/[0.5]">
      ...
      <Teleport to="#app-after">
        ...
        <Transition name="slide-fade-from-up" mode="out-in">
          <div
            ...
            class="fixed lg:hidden bg-gray-100 dark:bg-slate-800 pt-20 top-0 left-0 w-screen h-screen z-30 flex flex-col"
          >
